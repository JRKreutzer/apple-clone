...
const VideoCarousel = () => {
    ...
    useEffect(() => {
        ...
        if (span[videoId]) {
            // Animata o progresso do vídeo (aquela barrinha que corre junto com o vídeo)
    ...
    const handleLoadedMetadata = (i, e) => setLoadedData((prevLoad) => [...prevLoad, e])
                            ...
                            <div className="video-carousel_container">
                                <div className="w-full h-full flex-center rounded-3xl overflow-hidden bg-black">
                                    <video
                                        ...
                                        preload="auto"
                                        muted
                                        className={`${list.id === 3 && 'translate-x-44'} pointer-events-none`}
